  ...
  - heading: "Confirm before publishing"
    rows:
      - label: "Cover material"
        value: "Confirm with SMS whether the standard Top Hat cover housing is ductile iron, PP composite, or a mix, and whether GlobalMark WaterMark certification (referenced on the previous SMS website) still applies to the current range"
