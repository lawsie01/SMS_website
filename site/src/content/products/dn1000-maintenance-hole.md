  ...
  - heading: "Component weights"
    rows:
      ...
      - label: "Concrete load distribution ring option"
        value: "180kg"
configurationsIntro: "The DN1000 Hole base part code encodes the inlet/outlet size and RRJ angle: MHB1000<size><angle>. The diagram below shows the eight angle options as installed (viewed in plan, looking down); the table gives the DN150 part code for each — swap 150 for 225, 300 or 375 to get the same angle at a larger inlet/outlet size. 32 base configurations are available in total, plus separate riser, cone, seal and access cover codes."
...
configurations:
  ...
  - code: "MHB10001504WC"
    ...
    size: "DN150"
  - code: "MHB1000225090"
    configuration: "RRJ 90° (same 8 angles as DN150, above)"
    size: "DN225"
  - code: "MHB1000300090"
    configuration: "RRJ 90° (same 8 angles as DN150, above)"
    size: "DN300"
