...
productImage: "../../assets/images/dn1000-assembly-clean.jpg"
productImageBackground: "white"
  ...
  - heading: "Component weights"
    rows:
      ...
      - label: "Concrete load distribution ring option"
        value: "180kg"
configurationsIntro: "The access cover, cone, riser and seals shown in the assembly diagram above are each their own part code — full list below."
...
configDiagramCaption: "Base configurations viewed in plan, looking down — the arrow marks the downstream (outlet) direction. The angle in brackets is the pipeline's deflection from straight-through."
configPhotos:
...
configGroups:
  ...
  - heading: "DN375 inlet/outlet"
    rows:
      ...
      - code: "MHB10003754WC"
        configuration: "RRJ Cross (4-Way)"
assemblyDiagram: "../../assets/images/dn1000-exploded-assembly-diagram.png"
assemblyDiagramAlt: "Exploded view of the SMS DN1000 Maintenance Hole assembly showing, top to bottom: MH TH access cover (ACCMHTHCSDMH), EPDM seal (MHG0625), MH cone (MHRC600), MH riser sections (MH10000250/500/750/1000), a second EPDM seal (MHG1000) and the MH base"
assemblyDiagramCaption: "Exploded assembly, top to bottom — the access cover, cone and riser(s) stack onto the base with an EPDM seal at each joint. Riser heights combine in 250mm increments to reach the required installation depth."
componentPhotos:
  ...
  - heading: "Person entry"
    ...
    images:
      ...
      - image: "../../assets/images/dn1000-ladder-pov-inside.jpg"
        ...
        caption: "Looking down from the ladder — the anti-slip base floor and an inlet socket."
standards:
  - code: "WSA 137:2019"
...
faqs:
  ...
  - question: "Are all DN1000 Hole components under 25kg?"
    answer: "No — component weight varies by part. The 250mm riser and cone are 15–25kg and manual-handled easily, but the base (50–65kg) and taller risers (up to 45kg for the 1000mm riser) typically need two installers, and the concrete access cover options (180–200kg) need mechanical assistance to place — usually the excavator already on site for the dig."
