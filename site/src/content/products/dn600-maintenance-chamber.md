...
configGroupsIntro: "All 9 configurations are listed below, grouped by inlet/outlet size. Expand a size to find its part code."
configGroups:
...
componentPhotos:
  ...
  - image: "../../assets/images/dn600-seal-component.jpg"
    alt: "Placeholder tile for the DN600 EPDM/SBR element seal, still to be supplied"
    caption: "EPDM/SBR seal (ARH0600). One at the base joint, one under the Top Hat. Image to come."
  ...
  - image: "../../assets/images/dn600-vegetation-ring-component.jpg"
    alt: "Concrete vegetation ring, the annular collar that drops over the Top Hat access cover"
    caption: "Concrete vegetation ring (MCCCVS)."
  - image: "../../assets/images/dn600-lateral-component.jpg"
    alt: "Rubber collar seal for a drilled-in lateral connection"
    caption: "Lateral connection seal, DN100 or DN150."
...
configurations:
  ...
  - code: "AXEDO 150 and AXEDO 225 series"
    ref: 4
    configuration: "Base"
...
installationSections:
  ...
  - heading: "Access cover options"
    ...
    bullets:
      ...
      - "Top Hat access cover with a concrete infill lid (ACCMHTHCIFD)"
...
faqs:
  ...
  - question: "Is the DN600 Chamber rated for Class D traffic loads?"
    answer: "Yes. The Top Hat access cover is rated Class D maximum (trafficable) to AS 3996, and the load distributes to the surrounding foundation rather than the riser."
